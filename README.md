...
Current stable release: [GitHub Releases (latest)](https://github.com/uibcdf/smonitor/releases/latest).
Published `noarch: python` packages are available from the UIBCDF Conda channel
for Python 3.11--3.14. [Zenodo's SMonitor record](https://doi.org/10.5281/zenodo.22872341)
lists independently archived source snapshots; it does not archive Conda packages.
