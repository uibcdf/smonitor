...
version = smonitor.__version__.split('+')[0]
release = smonitor.__version__.split('+')[0]
...
html_theme_options = {
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/uibcdf/smonitor",
