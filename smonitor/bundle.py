    ...
    *,
    ...
    data = {
        ...
        "triage": {
            ...
            "events_by_source": report.get("events_by_source", {}),
            "events_by_resource": report.get("events_by_resource", {}),
            ...
            "top_codes": report.get("top_codes", []),
            "top_sources": report.get("top_sources", []),
            "top_fingerprints": report.get("top_fingerprints", []),
            "most_noisy_resources": report.get("most_noisy_resources", []),
            "most_expensive_entries": report.get("most_expensive_entries", []),
            "most_expensive_tags": report.get("most_expensive_tags", []),
            "blocking_incidents": report.get("blocking_incidents", []),
            "actionable_incidents": report.get("actionable_incidents", []),
            "recurrent_incidents": report.get("recurrent_incidents", []),
        },
        "events": events,
        "redactions": {
            "drop_extra": drop_extra,
