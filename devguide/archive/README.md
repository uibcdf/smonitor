...
| [`release_citation_version_lags_tag.md`](release_citation_version_lags_tag.md) | `resolved` | [uibcdf/smonitor#30](https://github.com/uibcdf/smonitor/issues/30) | The 0.17.1 citation version lags its immutable release tag. |
...
| [`resolve_support_library_dependency_cycles.md`](resolve_support_library_dependency_cycles.md) | `resolved` | [uibcdf/smonitor#29](https://github.com/uibcdf/smonitor/issues/29) | Resolve ArgDigest and DepDigest dependency cycles at SMonitor boundaries. |
| [`review_python_ecosystem_policy_adoption.md`](review_python_ecosystem_policy_adoption.md) | `resolved` | [uibcdf/smonitor#24](https://github.com/uibcdf/smonitor/issues/24) | Review inherited Python ecosystem policies for SMonitor. |
| [`routine_release_no_longer_publishes_conda.md`](routine_release_no_longer_publishes_conda.md) | `resolved` | [uibcdf/smonitor#20](https://github.com/uibcdf/smonitor/issues/20) | Routine GitHub Releases no longer publish Conda packages |
